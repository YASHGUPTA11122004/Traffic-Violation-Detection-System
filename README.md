...
## ✨ Features# 🚔 Traffic Violation Detection & E-Challan Generation System
...
### 🔗 [**Live Demo**](https://huggingface.co/spaces/yashgupta11122004/traffic-violation-detection) · 📁 [Cloud Deployment Code](./deployment)
...
├── deployment/                  # Cloud-deployable version (HuggingFace Spaces)
│   ├── app.py                   # Single-file Flask app for cloud deploy
│   ├── Dockerfile
│   ├── requirements.txt
...
- [deployment/README.md](deployment/README.md) — Cloud deployment guide and live demo info
